...
function MultiSelectControl({
  ...
  useEffect(() => {
    // When there's no pluginId yet, the component below always renders the
    // "save the plugin first" message without consulting `opts`, so there's
    // nothing to reset here.
    if (!dynamic || !pluginId) return
    let cancelled = false
    api
